...
#define CAPTAIN "舰长"
#define EXECUTIVE_OFFICER "副官" //Currently disabled.
#define FIELD_COMMANDER "战地指挥官"
#define STAFF_OFFICER "参谋军官"
#define TRANSPORT_OFFICER "运输军官"
#define PILOT_OFFICER "飞行员"
#define MECH_PILOT "机甲驾驶员"
#define ASSAULT_CREWMAN "突击船员"
#define TRANSPORT_CREWMAN "运输船员"
#define REQUISITIONS_OFFICER "补给军官"
#define CHIEF_SHIP_ENGINEER "首席舰船工程师"
#define CHIEF_MEDICAL_OFFICER "首席医疗官"
#define CORPORATE_LIAISON "企业联络官"
#define SYNTHETIC "合成人"
#define SHIP_TECH "舰船技术员"
#define MEDICAL_DOCTOR "医生"
#define MEDICAL_RESEARCHER "医学研究员"
#define SQUAD_LEADER "班长"
#define SQUAD_SPECIALIST "专家"
#define SQUAD_SMARTGUNNER "智能机枪手"
#define SQUAD_CORPSMAN "卫生兵"
#define SQUAD_ENGINEER "工程兵"
#define SQUAD_MARINE "陆战队员"
#define SQUAD_ROBOT "机器人"
#define SQUAD_VATGROWN "培养兵"
#define SILICON_AI "人工智能"

//SOM
#define SOM_COMMANDER "SOM指挥官"
#define SOM_FIELD_COMMANDER "SOM战地指挥官"
#define SOM_STAFF_OFFICER "SOM参谋军官"
#define SOM_PILOT_OFFICER "SOM飞行员"
#define SOM_MECH_PILOT "SOM机甲驾驶员"
#define SOM_REQUISITIONS_OFFICER "SOM补给军官"
#define SOM_CHIEF_ENGINEER "SOM首席工程师"
#define SOM_CHIEF_MEDICAL_OFFICER "SOM首席医疗官"
#define SOM_TECH "SOM技术员"
#define SOM_MEDICAL_DOCTOR "SOM医生"
#define SOM_CHEF "SOM厨师"

#define SOM_SQUAD_LEADER "SOM班长"
#define SOM_SQUAD_CORPSMAN "SOM卫生兵"
#define SOM_SQUAD_ENGINEER "SOM工程兵"
#define SOM_SQUAD_VETERAN "SOM资深兵"
#define SOM_SQUAD_MARINE "SOM标准兵"

#define JOB_CAT_COMMAND "指挥"
#define JOB_CAT_SILICON "硅基"
#define JOB_CAT_REQUISITIONS "补给"
#define JOB_CAT_MEDICAL "医疗"
#define JOB_CAT_ENGINEERING "工程"
#define JOB_CAT_CIVILIAN "平民"
#define JOB_CAT_MARINE "陆战队"
#define JOB_CAT_XENO "异形"
#define JOB_CAT_UNASSIGNED "未分配"

#define JOB_COMM_TITLE_SQUAD_LEADER "SL"

#define ROLE_XENOMORPH "异形"
#define ROLE_XENO_QUEEN "异形女王"
#define ROLE_ERT "紧急响应小组"
#define ROLE_VALHALLA "瓦尔哈拉"
