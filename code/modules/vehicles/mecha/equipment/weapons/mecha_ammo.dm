...
/obj/item/mecha_ammo/attack_self(mob/user)
	..()
	if(rounds)
		to_chat(user, span_warning("弹药箱清空前无法压扁！"))
		return
...
/obj/item/mecha_ammo/missiles_br
	name = "破门导弹"
	desc = "一箱大型导弹，已准备就绪，可装入BRM-6外骨骼导弹发射架。"
...
/obj/item/mecha_ammo/flashbang
	name = "可投掷闪光弹"
	desc = "一盒光滑的闪光弹，用于大型外骨骼发射器。无法手动启动。"
...
/obj/item/mecha_ammo/clusterbang
	name = "可投掷闪光弹集束"
	desc = "一盒集束闪光弹，专为特种外骨骼集束发射器设计。无法手动引爆。"
...
/obj/item/mecha_ammo/vendable/burstrifle
	name = "一盒爆裂步枪弹道弹"
	desc = "一盒大型火箭助推连发步枪弹道弹药。侧面写着'请勿用作鞭炮'。"
...
/obj/item/mecha_ammo/vendable/rpg
	name = "高爆导弹"
	desc = "一枚地球政府殖民地海军陆战队的机甲导弹。你大概不该用任何东西去碰它的尖头。"
	icon_state = "rpg_ammo"
	rounds = 10
...
/obj/item/mecha_ammo/vendable/minigun
	name = "一箱火神炮弹道弹药"
	desc = "可惜的是，从火神炮射出的每一发弹道弹药都必须事先装填进去。"
...
/obj/item/mecha_ammo/vendable/sniper
	name = "狙击弹道弹匣"
	desc = "一盒反坦克弹道弹药，用于射击小型装甲车辆和小型装甲生物。"
...
/obj/item/mecha_ammo/vendable/flamer
	name = "喷火器凝固汽油罐"
	desc = "专为补充地球政府殖民地海军陆战队标准机甲喷火器燃料而设计的专用燃料罐。"
