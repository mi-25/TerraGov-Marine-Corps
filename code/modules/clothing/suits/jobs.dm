...
/obj/item/clothing/suit/storage/det_suit
	name = "外套"
	desc = "一件18世纪的多用途战壕风衣。穿上它的人，意味着要动真格了。"
...
/obj/item/clothing/suit/storage/internalaffairs/verb/toggle()
	...
	switch(icon_state)
		if("ia_jacket_open")
			...
			to_chat(usr, "你扣上了夹克的纽扣。")
		if("ia_jacket")
			src.icon_state = "ia_jacket_open"
			to_chat(usr, "你解开了夹克的纽扣。")
		else
			to_chat(usr, "你试图扣上[src]的魔术贴，但很快就意识到这行不通。")
			return FALSE
