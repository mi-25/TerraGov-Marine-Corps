...
/obj/item/weapon/heldglove/boxing/attack(mob/living/M, mob/living/user)
	...
	target.balloon_alert_to_viewers("击倒！！！", ignored_mobs = target)
	to_chat(target, span_userdanger("你放弃了，倒下了！被击倒了！"))
...
/obj/structure/punching_bag
	name = "拳击沙袋"
	desc = "一个纳米传讯的沙袋。在离太阳系这么远的地方很常见。\n廉价且不结实，如果被太重的东西击中可能会坏掉。"
