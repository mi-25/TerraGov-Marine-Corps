...
/obj/item/weapon/gun/energy/lasgun/lasrifle/plasma/rifle
	name = "\improper PL-38等离子体步枪"
	desc = "PL-38等离子体步枪是地球政府殖民地海军陆战队军械库中的实验性新增装备，据传是某些幕后合同交易的产物。如果你不介意其相当廉价的冷却系统，它是一款多功能武器。它拥有类似步枪的标准光束模式、能轻易穿透软目标的高功率模式，以及能轻松熔化任何被击中目标装甲的爆破模式。"
...
/obj/item/weapon/gun/energy/lasgun/lasrifle/plasma/cannon
	...
	desc = "PL-96等离子炮是地球政府殖民地海军陆战队军械库中的实验性新增装备，据传是某些幕后合同交易的产物，是一款绝对令人难以置信的毁灭性武器……前提是你能忍受其极其糟糕的冷却机制和整个系统的笨重。它拥有类似机枪的标准光束模式，一种会在后续留下毁灭性火焰的火球模式，以及一种因其击中目标时惊人的破甲潜力而被戏称为'股骨粉碎者'的蓄力模式。"
...
/obj/item/weapon/gun/energy/lasgun/lasrifle/plasma/smg
	name = "\improper PL-51 等离子体冲锋枪"
	desc = "PL-51等离子体冲锋枪是TGMC等离子体武器系列的又一实验性补充，有人推测这是让AI设计和生成武器蓝图与配置方案计划的一部分。它与其他等离子体武器共享相同的冷却系统，无法持续射击。与同系列其他武器相比，它更轻便、更易操控，且可单手射击。拥有两种射击模式：标准模式可让子弹从墙壁和固体表面反弹；过载模式射速较慢，但命中目标时会造成小范围中等伤害的爆炸。"
