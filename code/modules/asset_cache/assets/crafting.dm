...
/datum/asset/spritesheet/crafting/proc/add_tool_icons()
	var/list/tool_icons = list(
		TOOL_CROWBAR = icon('icons/obj/items/tools.dmi', "crowbar"),
		TOOL_MULTITOOL = icon('icons/obj/items/tools.dmi', "multitool"),
		TOOL_SCREWDRIVER = icon('icons/obj/items/tools.dmi', "screwdriver_map"),
		TOOL_WIRECUTTER = icon('icons/obj/items/tools.dmi', "cutters_map"),
		TOOL_WRENCH = icon('icons/obj/items/tools.dmi', "wrench"),
		TOOL_WELDER = icon('icons/obj/items/tools.dmi', "welder"),
		TOOL_ANALYZER = icon('icons/obj/items/tools.dmi', "analyzer"),
		TOOL_MINING = icon('icons/obj/items/tools.dmi', "minipick"),
		TOOL_SHOVEL = icon('icons/obj/items/tools.dmi', "spade"),
		TOOL_RETRACTOR = icon('icons/obj/items/surgery_tools.dmi', "retractor"),
		TOOL_HEMOSTAT = icon('icons/obj/items/surgery_tools.dmi', "hemostat"),
		TOOL_CAUTERY = icon('icons/obj/items/surgery_tools.dmi', "cautery"),
		TOOL_DRILL = icon('icons/obj/items/surgery_tools.dmi', "drill"),
		TOOL_SCALPEL = icon('icons/obj/items/surgery_tools.dmi', "scalpel"),
		TOOL_SAW = icon('icons/obj/items/surgery_tools.dmi', "saw"),
		TOOL_BONESET = icon('icons/obj/items/surgery_tools.dmi', "bonesetter"),
		TOOL_KNIFE = icon('icons/obj/items/kitchen_tools.dmi', "knife"),
		TOOL_BLOODFILTER = icon('icons/obj/items/surgery_tools.dmi', "bloodfilter"),
		TOOL_ROLLINGPIN = icon('icons/obj/items/kitchen_tools.dmi', "rolling_pin"),
		TOOL_RUSTSCRAPER = icon('icons/obj/items/tools.dmi', "wirebrush"),
	)
