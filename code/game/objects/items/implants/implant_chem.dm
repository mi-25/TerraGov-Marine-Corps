/obj/item/implant/chem
	name = "化学植入物"
	desc = "一种化学植入物，内含单次使用的化学混合物，可通过注射器添加。"
	allow_reagents = TRUE
...
/obj/item/implant/chem/implant(mob/living/carbon/human/target, mob/living/user)
	...
	to_chat(user, span_notice("[src]在[target]中现在将通过说出包含短语''[activation_phrase]''的内容来激活，<B>说[activation_phrase]</B>来尝试激活。"))
	return ..()

/obj/item/implant/chem/blood
	name = "血液恢复植入体"
	desc = "一种化学植入物，能够加速血液恢复，补充流失的血液。"
