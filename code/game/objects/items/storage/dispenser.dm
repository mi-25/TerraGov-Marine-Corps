...
/obj/machinery/deployable/dispenser
	name = "TX-9000 补给发放机"
	desc = "TX-9000，又称'补给机'，是一种能够储存大量物品并治疗附近合成人的机器。你的队友经常会要求你部署一台这样的设备。"
	density = TRUE
	anchored = TRUE
	max_integrity = 250
...
/obj/item/storage/backpack/dispenser
	name = "TX-9000 补给发放机"
	desc = "TX-9000，又称'补给机'，是一种能够储存大量物品并治疗附近合成人的机器。你的队友经常会要求你部署一台。"
...
/obj/item/storage/backpack/dispenser/do_quick_equip(mob/user)
	to_chat(usr, span_notice("[src]未展开时，你无法从中取出任何物品。"))
