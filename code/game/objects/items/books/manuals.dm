...
/obj/item/book/manual/marine_law
	name = "太空法"
	desc = "一套适用于民用、私人和军用舰船的通用法律与秩序维护准则。"
	icon_state = "bookSpaceLaw"
	author = "The Company"
	title = "Space Law"
