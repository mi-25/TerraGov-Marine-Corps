...
/obj/item/encryptionkey/cas
	name = "\improper 火力支援专家无线电加密密钥"
	icon_state = "rob_cypherkey"
	channels = list(RADIO_CHANNEL_CAS = TRUE)

/obj/item/encryptionkey/mcom
	name = "\improper 陆战队指挥部无线电加密密钥"
