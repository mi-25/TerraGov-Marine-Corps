...
/obj/machinery/marine_selector/clothes/commander/Initialize(mapload)
	...
	listed_products = list(
		/obj/effect/vendor_bundle/basic_commander = list(CAT_STD, "标准装备包", 0, "white"),
		/obj/effect/vendor_bundle/basic_jaeger_commander = list(CAT_STD, "基础杰格装备包", 0, "white"),
		/obj/effect/vendor_bundle/xenonauten_light/leader = list(CAT_AMR, "异形猎人轻型护甲包", 0, "orange"),
		/obj/effect/vendor_bundle/xenonauten_medium/leader = list(CAT_AMR, "异形猎人中型护甲包", 0, "orange"),
		/obj/effect/vendor_bundle/xenonauten_heavy/leader = list(CAT_AMR, "异形猎人重型护甲包", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger/light = list(CAT_AMR, "杰格侦察兵轻型外骨骼", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger/light/skirmisher = list(CAT_AMR, "杰格散兵轻型外骨骼", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger = list(CAT_AMR, "杰格步兵中型外骨骼", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger/eva = list(CAT_AMR, "杰格EVA中型外骨骼", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger/heavy = list(CAT_AMR, "杰格冈尼尔重型外骨骼", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger/heavy/assault = list(CAT_AMR, "杰格突击重型外骨骼", 0, "orange"),
		/obj/item/clothing/suit/modular/jaeger/heavy/eod = list(CAT_AMR, "杰格排爆重型外骨骼", 0, "orange"),
		...
		/obj/item/armor_module/storage/uniform/black_vest = list(CAT_WEB, "战术黑背心", 0, "black"),
		/obj/item/armor_module/storage/uniform/webbing = list(CAT_WEB, "战术织带", 0, "black"),
		/obj/item/armor_module/storage/uniform/holster = list(CAT_WEB, "肩部手枪套", 0, "black"),
		...
		/obj/item/storage/belt/sparepouch = list(CAT_BEL, "G8通用工具包", 0, "black"),
		/obj/item/belt_harness/marine = list(CAT_BEL, "腰带挂带", 0, "black"),
		/obj/item/armor_module/module/welding = list(CAT_HEL, "杰格焊接模块", 0, "orange"),
		/obj/item/armor_module/module/binoculars = list(CAT_HEL, "杰格双筒望远镜模块", 0, "orange"),
		/obj/item/armor_module/module/artemis = list(CAT_HEL, "杰格弗雷尔模块", 0, "orange"),
		/obj/item/armor_module/module/antenna = list(CAT_HEL, "杰格天线模块", 0, "orange"),
		/obj/item/clothing/head/tgmcberet/fc = list(CAT_HEL, "野战指挥官贝雷帽", 0, "black"),
		...
		/obj/item/storage/pouch/shotgun = list(CAT_POU, "霰弹枪弹壳包", 0, "black"),
		/obj/item/storage/pouch/general/large = list(CAT_POU, "通用包", 0, "black"),
		/obj/item/storage/pouch/magazine/large = list(CAT_POU, "弹匣包", 0, "black"),
		/obj/item/storage/holster/flarepouch/full = list(CAT_POU, "信号弹包", 0, "black"),
		...
		/obj/item/storage/pouch/tools/full = list(CAT_POU, "工具包（含工具）", 0, "black"),
		/obj/item/storage/pouch/grenade/slightlyfull = list(CAT_POU, "手榴弹包（含手榴弹）", 0,"black"),
		/obj/item/storage/pouch/construction/full = list(CAT_POU, "建筑包（含材料）", 0, "black"),
		/obj/item/storage/pouch/magazine/pistol/large = list(CAT_POU, "手枪弹匣包", 0, "black"),
		/obj/item/storage/pouch/pistol = list(CAT_POU, "副武器包", 0, "black"),
		/obj/item/storage/pouch/explosive = list(CAT_POU, "爆炸物包", 0, "black"),
		...
		/obj/effect/vendor_bundle/tyr = list(CAT_ARMMOD, "马克1型提尔额外装甲套装", 0,"black"),
		...
		/obj/item/armor_module/module/armorlock = list(CAT_ARMMOD, "索尔装甲锁定模块", 0, "black"),
		/obj/item/clothing/mask/gas = list(CAT_MAS, "透明防毒面具", 0,"black"),
		/obj/item/clothing/mask/gas/tactical = list(CAT_MAS, "战术防毒面具", 0,"black"),
		/obj/item/clothing/mask/gas/tactical/coif = list(CAT_MAS, "战术头巾式防毒面具", 0,"black"),
